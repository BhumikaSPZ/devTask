...
function loadTest() {
    ...
    // Create Cookie
    var cookieName = '#1114-Checkout-Redesign-12022021 V4';
    var cookieValue = '1';
    var myDate = new Date();
    ...
    function initSelector() {
        var setHeadingEleInterval = setInterval(function () {
            ...
            if (headingEle) {
                ...
                headingEle?.parentElement?.parentElement?.children[headingEle?.parentElement?.parentElement?.childElementCount - 3]?.nextElementSibling?.classList.add('spz-control-heading');
    ...
    var callback = function (mutationsList, observer) {
        for (var mutation of mutationsList) {
            ...
            if (!mainHeader && document.querySelector('.spz-wrapper')) {
	            ...
	            paypalBtnImg.setAttribute('src', '//res.cloudinary.com/spiralyze/image/upload/f_auto/Ubsersuggest/1114%20-%20Checkout%20-%20Redesign/paypal_btn_img_v3.png');
            ...
            (!document.querySelector('.spz-switch-plan-link') && leftBlock?.childElementCount == 8)) {
                var target = mutation.addedNodes[0] || leftBlock.children[2];
