...
function loadTest() {
    ...
    var callback = function (mutationsList, observer) {
        for (var mutation of mutationsList) {
        	...
        	if (submitBtn && dropdownEle){
            	var infoTxt = document.querySelector('.selector-value > div > div:nth-child(2)');
					var price = infoTxt.querySelector('b')?.innerText;
				if (plan == "lifetime" && document.body.classList.contains('isLifeTime')) {
	            	submitBtn.children[0].innerHTML = 'GET LIFETIME ACCESS FOR ' + price ;	
	            }
