...
function loadTest() {
    ...
    var callback = function (mutationsList, observer) {
        for (var mutation of mutationsList) {
            ...
            // Change dropdown plan change Text
            // var target =  document.querySelector('.selector-value>div:first-child');
            // target.children[0].innerHTML = isLifeTime ? 'Individual - Lifetime' : 'Individual - Monthly';
            // console.log(target)
            
            // target.classList.add('dropdown-plan-text');
            ...
            // var abc =  leftBlock.children[4];
            // abc.classList.add('.spz-info-txt');
