        ...
        function addModalFunc() {
            ...
            if (!jQuery('body').hasClass('show-popup-modal')) {
                        ...
                        <div class="timer-popup-inner">\
                            ...
                            <div class="popup-content">\
                                <div class="timer-wrapper">\
                                    <div class="days-wrapper"><div class="days" id="days">00</div><p>days</p></div>\
                                    <div class="separater"></div>\
                                    <div class="hours-wrapper"><div class="hours" id="hours">00</div><p>hours</p></div>\
                                    <div class="separater"></div>\
                                    <div class="minutes-wrapper"><div class="minutes" id="minutes">00</div><p>min</p></div>\
                                </div>\
				...
				var timerInterval = setInterval(function() {
				    ...
				    var endDate = new Date("2021-03-16T08:45:00-08:00");
				    var currentDate = new Date();
				    
				    var timeDifference = endDate.getTime() - currentDate.getTime();
				    
				    var daysRemain = (timeDifference / (1000  * 60 * 60 * 24)).toFixed(0);
				    var hoursRemain = ((timeDifference / (1000  * 60 * 60)) % 24).toFixed(0);
				    var minutesRemain = Math.ceil((timeDifference / (1000  * 60)) % 60);
