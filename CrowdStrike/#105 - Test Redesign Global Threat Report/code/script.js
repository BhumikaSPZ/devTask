if (!$('body').hasClass('redesign-global-threat')) {
    ...
    // form popup
        ...
        $('.redesign-global-threat .global-threat-report .book-highlights .mobile-img img').attr('src','//res.cloudinary.com/spiralyze/image/upload/f_auto/CrowdStrike/105_Redesign_Global_Threat_Report/threat-report-book-new.png');
