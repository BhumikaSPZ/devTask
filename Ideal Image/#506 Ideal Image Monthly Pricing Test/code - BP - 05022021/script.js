var setjQueryInterval = setInterval(function() {
    ...
    if(typeof $ != 'undefined'){
        ...
        if(!body.hasClass('spz-lp-botox')){
			...
			// update hero image
            $('.heroBox-image .vc_single_image-wrapper').html('<img src="//res.cloudinary.com/spiralyze/image/upload/v1612501276/Ideal%20Image/350-Ideal_Image-Botox_LP-Imagery-Testing/Botox_v2.gif" alt="face spa result">');
